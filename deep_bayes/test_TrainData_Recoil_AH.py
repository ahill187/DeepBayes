...
sys.path.append('/home/ahill/DeepLearning/CMSSW_10_2_0_pre5/src/DeepJetCore/evaluation')
sys.path.append('/home/ahill/DeepLearning/CMSSW_10_2_0_pre5/src/DeepJetCore/compiled')
...
MODELLIST= {
          ...
          # DEEPBAYES
          200: { "method":meanDNN, 'arch':'32x16x4',           "dropout":0.2, "batchNorm": True, "splitInputs": False,  'pfix':'', "loss":ahuber, "learningrate":0.0001,  "nepochs":50, "batchsize":1024 },
}
